...
if( !defined('EVENT_ORGANIZER_TOOLKIT_PARTICIPANTS_TABLE') )
	define( 'EVENT_ORGANIZER_TOOLKIT_PARTICIPANTS_TABLE', 'eot_participants' );
if( !defined('EVENT_ORGANIZER_TOOLKIT_PARTICIPANTS_PARENTS_TABLE') )
	define( 'EVENT_ORGANIZER_TOOLKIT_PARTICIPANTS_PARENTS_TABLE', 'eot_participants_parents' );
if( !defined('EVENT_ORGANIZER_TOOLKIT_PARTICIPANT_ROLES_TABLE') ) 
	define( 'EVENT_ORGANIZER_TOOLKIT_PARTICIPANT_ROLES_TABLE', 'eot_participants_roles' );
...
if( !defined('EVENT_ORGANIZER_TOOLKIT_MEAL_TYPES_TABLE') ) 
	define( 'EVENT_ORGANIZER_TOOLKIT_MEAL_TYPES_TABLE', 'eot_meal_types' );
...
if( !defined('EVENT_ORGANIZER_TOOLKIT_ACCOMMODATIONS_TABLE') ) 
	define( 'EVENT_ORGANIZER_TOOLKIT_ACCOMMODATIONS_TABLE', 'eot_accommodations' );
 ...
 */
require plugin_dir_path( __FILE__ ) . 'blocks/eot-blocks.php';
