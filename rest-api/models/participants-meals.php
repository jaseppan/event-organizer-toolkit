...
/**
 * Class contains handling CRUD related to participants meals
 *
 ...
 */
 ...
 class Event_Organizer_Toolkit_Participants_Meals_Handler extends Event_Organizer_Toolkit_Request_Handler {

    /**
	 * The database table for participants meals.
	 *
	 * @since    1.0.0
	 * @access   public
	 * @var      string    $table    The database table for participants meals.
	 */
      ...
      *
      * @since    1.0.0
      * @param      string    $table       The database table for participants meals.
      */
     ...
     public function __construct() {
         ...
         $this->table = $wpdb->prefix . EVENT_ORGANIZER_TOOLKIT_PARTICIPANT_MEALS_TABLE;
    ...
    /**
     * Handler for wp-json/event-organizer-toolkit/v1/list-participants-meals endpoint
     * 
     * @since 1.0.0
     */   
    ...
    /**
     * Handler for wp-json/event-organizer-toolkit/v1/get-participants-meals endpoint
     * 
     * @since 1.0.0
     */   
    ...
    /**
     * Handler for wp-json/event-organizer-toolkit/v1/delete-participants-meals endpoint
     * 
     * @since 1.0.0
     */   
