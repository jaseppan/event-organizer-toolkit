...
/**
 * Class contains handling CRUD related to participants parents
 *
 ...
 */
 ...
 class Event_Organizer_Toolkit_Participants_Parents_Handler extends Event_Organizer_Toolkit_Request_Handler {

    /**
	 * The database table for participants parents.
	 *
	 * @since    1.0.0
	 * @access   public
	 * @var      string    $table    The database table for participants parents.
	 */
      ...
      *
      * @since    1.0.0
      * @param      string    $table       The database table for participants parents.
      */
     ...
     public function __construct() {
         ...
         $this->table = $wpdb->prefix . EVENT_ORGANIZER_TOOLKIT_PARTICIPANT_PARENTS_TABLE;
    ...
    /**
     * Handler for wp-json/event-organizer-toolkit/v1/list-participants-parents endpoint
     * 
     * @since 1.0.0
     */   
    ...
    /**
     * Handler for wp-json/event-organizer-toolkit/v1/get-participants-parents endpoint
     * 
     * @since 1.0.0
     */   
    ...
    /**
     * Handler for wp-json/event-organizer-toolkit/v1/delete-participants-parents endpoint
     * 
     * @since 1.0.0
     */   
